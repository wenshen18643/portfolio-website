...
- **Side Projects act**: an ink-deep subsection at the end of Experience, led by oversized poster typography and a simple editorial project row. It remains visually distinct from the professional story while sharing the same Experience destination.
